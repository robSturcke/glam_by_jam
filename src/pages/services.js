                  ...
                  <div className="card h-100">
                    <div className="card-body d-flex flex-column">
                      ...
                      <div className="card-text pb-3">
                        On location bridal services for you and your bridal
                        party. As a bride-to-be, you can be confident knowing we
                        will help create your perfect wedding makeup and I
                        accommodate small to large bridal parties.
                      </div>
                ...
                <div className="col-md-6 mb-4">
                  <div className="card mb-3 h-100">
                    <div className="card-body d-flex flex-column">
                      ...
                      <div className="card-text pb-3">
                        Look flawless for any event, from proms to photoshoots
                        or a special night out! Jamie will consult with you
                        about your custom look for any event or occasion.
                      </div>
                      <div className="mt-auto">
                        <span className="card_footer">
                ...
                <div className="col-md-6 mb-4">
                  <div className="card h-100">
                    <div className="card-body d-flex flex-column">
                      ...
                      <div className="card-text pb-3">
                        Makeup should be fun and effortless. Jamie will teach
                        you how to create wearable looks - whether you natural
                        glam for the day or a smokey eye to impress.
                      </div>
                      <div className="mt-auto">
                        <span className="card_footer">
                          <Link to="/contact">$100</Link>
